...
public:
  enum {
    ...
    MUL = 8, DIV = 9, MOD = 10, ADD = 11, SUB = 12, HEX_NUMBER = 13, INTEGER = 14, 
    FLOAT = 15, EXP_NUMBER = 16, COMMENT = 17, NAME = 18, NEWLINE = 19, 
    WS = 20
  };

  enum {
    RuleProg = 0, RuleExpr = 1, RuleVar = 2, RuleNum = 3
  };
  ...
  class  InlineVarExprContext : public ExprContext {
  public:
    InlineVarExprContext(ExprContext *ctx);
  ...
  class  FactExprContext : public ExprContext {
  public:
    FactExprContext(ExprContext *ctx);
  ...
  class  RoundExprContext : public ExprContext {
  public:
    RoundExprContext(ExprContext *ctx);
  ...
  public:
    ...
    antlr4::tree::TerminalNode *EXP_NUMBER();
